...
public class Main extends JFrame {
	public Main() {
		DefaultMutableTreeNode top, a1, a2, id3, id4, lp1, st1, rp1, exp3, id2, exp4, id1, exp1, exp2, id, equals, exp,lp,rp,st,pl,a,b,c;
		...
		a2 = new DefaultMutableTreeNode("A");
